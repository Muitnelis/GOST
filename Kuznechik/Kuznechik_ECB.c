...
// Шифр Kuznechik
void Kuznechik(unsigned char* block, unsigned char* keys)
{
    for (int i = 0; i < 9; i++)
    {
...
void Kuznechik_ECB(unsigned char* input_file_path, unsigned char* output_file_path, unsigned char* key_file)
{
    unsigned char buffer[32];
    size_t buffer_len = 0;
